...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lume-model-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11020&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lume-model-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lume-model` can be installed with:

```
conda install lume-model
```

It is possible to list all of the versions of `lume-model` available on your platform with:
